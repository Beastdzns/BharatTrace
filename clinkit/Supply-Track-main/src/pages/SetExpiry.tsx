        ...
        {result.recommendedDiscount !== undefined && (
          <div style={{ 
            ...
            <p style={{ fontSize: '1.1rem', margin: '0.5rem 0' }}>
              <span style={{ fontWeight: 'bold' }}>Original price:</span> ₹{inputs.originalPrice.toFixed(2)}
            </p>
            <p style={{ fontSize: '1.1rem', margin: '0.5rem 0' }}>
              <span style={{ fontWeight: 'bold' }}>Recommended discount:</span> {result.recommendedDiscount?.toFixed(1)}%
            </p>
            <p style={{ fontSize: '1.1rem', margin: '0.5rem 0' }}>
              <span style={{ fontWeight: 'bold' }}>Discounted price:</span> ₹{result.discountedPrice?.toFixed(2)}
            </p>
            <p style={{ fontSize: '1.1rem', margin: '0.5rem 0' }}>
              <span style={{ fontWeight: 'bold' }}>Profit margin after discount:</span> {result.finalProfitMargin?.toFixed(1)}%
            </p>
          </div>
        )}
      </div>
